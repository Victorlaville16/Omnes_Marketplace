...
$request = $db->prepare("INSERT INTO vehicules (nom, prix, kilometrage, carburant, description, 
                ID_vendeur, photo1, photo2, photo3, methodeVente, gamme) 
                                VALUES ('$nom', '$prix', '$kilometrage', '$carburant', '$description', 
                                '$ID_vendeur', ?, ?, ?, '$methode', '$gamme')");
