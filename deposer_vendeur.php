...
<body>
    <div id="wrapper">
        ...
        <nav>
            <ul>
                ...
                <li><a href="deposer_vendeur.php">
                        <font color="#00C2CB">Déposer une annonce</font>
                    </a></li>
    ...
    <script>
                ...
                const dateFinRow = document.getElementById("dateFin");

                methodeSelect.addEventListener("change", function () {
                    if (methodeSelect.value == "encheres") {
                        dateFinRow.style.display = "table-row";
                    } else {
                        dateFinRow.style.display = "none";
                    }
                });
            </script>
